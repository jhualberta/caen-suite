...
#define CMD_NONE_CHAR       ('g')   // Character for CMD NONE
...
typedef enum {
    ...
    DPPDemo_Cmd_Configuration_Set,      // Configure Boards ('C')
    DPPDemo_Cmd_Configuration_Get,      // Get Board Configuration ('G')
    ...
    DPPDemo_Cmd_AttachBoards,           // Attach Boards ('H')
    DPPDemo_Cmd_None,                   // None command ('g')
} DPPDemo_Cmd_t;
